...
// Helper: Returns the full rectangle of a given position for a box with the given size
function box(x, y, size) {
	return [x * size, y * size, x * size + size, y * size + size];
}

// Helper: Returns true if a bounding box intersects another
function box_intersects(box1, box2) {
